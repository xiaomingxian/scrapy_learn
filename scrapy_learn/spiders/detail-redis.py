...
#
#
# redis_pool = redis.ConnectionPool(host='49.234.25.12', port=6379, decode_responses=True)
#
#
# con = connect(host='49.234.25.12', port=3306, user='root', passwd='Mysql_root_123456', db='landc', charset='utf8')
# cur = con.cursor()
#
#
...
#         sql = 'INSERT INTO landc_copy' + str(self.file_name) \
...
#             # con.commit()
#             self.r.set(url,str(obj))
#             print(
#                 '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~SSSSSSSSSSSSSSSSS 写入Redis成功 SSSSSSSSSSSSSSSSS~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
